...
export default function VolumeSummary({
  ...
  const categories = [
    ...
    { key: "pull" as const, label: "Pull", color: "bg-blue-400" },
    { key: "legs" as const, label: "Legs", color: "bg-green-400" },
  ...
  return (
    <div className="bg-surface rounded-xl p-4 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <span className="text-gray-400 text-xs">{fmt(totalVolume)} kg</span>
      </div>
